...
def create_vpc(client, vpc_cidr, vpc_name):
    ...
    try:
        ...
        try:
            ...
            print(f"Enabled DNS support for VPC {vpc_id}")
            ...
            print(f"Warning: Could not enable DNS attributes for VPC: {e}")
...
def create_security_group(client, vpc_id, group_name="btu-security-group"):
    ...
    try:
        ...
        if not my_ip:
            print("Error: Could not determine public IP. Cannot create security group.")
            return None
...
def launch_ec2_instance(
    ...
    try:
        ...
        if not ami_id:
            print("Error: Could not find a suitable AMI. Cannot launch instance.")
...
def create_rds_instance(
    ...
    try:
        ...
        if not subnet_group:
            print("Error: Could not create or find DB subnet group.")
...
def main():
    parser = argparse.ArgumentParser(
        description="AWS VPC, EC2, and RDS Management CLI Tool"
    )
